...
This isn't my script but I thought it would appeal to the reader of this blog. It's a script that will lookup the Google Page Rank for any website and uses the same interface as the Google Toolbar to do it. I'd like to thank Fred Cirera for writing it and you can checkout his blog about this script [here](http://blogmag.net/blog/read/91/Python_code_to_check_your_Google_PageRank).
...
The reason it is such an involved bit of math is that it needs to compute a checksum in order to work. It should be pretty reliable since it doesn't involve any scraping.
...
PageRank: 3   URL: http://www.halotis.com/
```
